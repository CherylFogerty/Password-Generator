...
var lowercaseChar = "abcedfghijklmnopqrstuvwxyz";
var uppercaseChar = "ABCEFGHIJKLMNOPQRSTUVWXYZ";
...
function determineUppercase(){
  ...
  alert("message:Please answer Yes or No");
  determineUppercase();
...
function determineNumbers(){
  ...
  }else if (numberCheck === "yes" || numberCheck){
    numberCheck = true;
    return numberCheck;

  }else if (numberCheck === "no" || numberCheck){
    numberCheck = false;
    return numberCheck;
...
//Function used to take all the input from the previous functions to generate a password using a random number and // the charAt method
